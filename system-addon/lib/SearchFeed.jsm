...
const CONTENT_SEARCH_READY = "content-search-initialized";
...
this.SearchFeed = class SearchFeed {
  addObservers() {
    ...
    Services.obs.addObserver(this, CONTENT_SEARCH_READY);
  }
  removeObservers() {
    Services.obs.removeObserver(this, SEARCH_ENGINE_TOPIC);
    Services.obs.removeObserver(this, CONTENT_SEARCH_READY);
  }
  observe(subject, topic, data) {
    switch (topic) {
      case CONTENT_SEARCH_READY:
        this.getState();
        break;
